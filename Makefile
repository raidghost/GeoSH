...
OBJECTS_CLIENT = main_client.o client.o callbacks.o game.o ServerTalk.o Structs.o
...
LIBS_CLIENT = -lgtk-3 -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lglib-2.0 -lm
OPTIONS = -std=gnu11
...
Structs.o : Structs.c
	gcc $(OPTIONS) $(CFLAGS_CLIENT) -c Structs.c


clean :
	rm -f $(OBJECTS_SERVER) $(OBJECTS_CLIENT) server client
